...
class LoginTest:
    ...
    def step_start_sesion(self):
        ...
        try:
            ...
            self.driver.save_screenshot("./PruebasAutomatizadasPY/LoginFailedTest/screenshot/step1_login_page.png")
            # Enter valid credentials
            username_field = self.driver.find_element(By.ID, "username")
            username_field.send_keys("IncorrectCredentials")
            ...
            self.driver.save_screenshot("./PruebasAutomatizadasPY/LoginFailedTest/screenshot/step1_login_submit.png")
...
def GenerateItsOwnReport():
    path = "./PruebasAutomatizadasPY/LoginFailedTest/report/Report.html"
...
def run_test():
    try:
        screenshot_dir = './PruebasAutomatizadasPY/LoginFailedTest/screenshot'
      ...
      report_dir = './PruebasAutomatizadasPY/LoginFailedTest/report'
