...
class Make_Post:
    ...
    def step_start_sesion(self):
        ...
        try:
            ...
            self.driver.save_screenshot("./PruebasAutomatizadasPY/PostFailedTest/screenshot/step1_login_page.png")
            ...
            self.driver.save_screenshot("./PruebasAutomatizadasPY/PostFailedTest/screenshot/step1_login_submit.png")
    ...
    def step_MakePost(self):
        ...
        try:
            postText = self.driver.find_element(By.ID, "CaptionBoxFalse")
            postText.send_keys("Esto es un post de prueba")
            postText.submit()
            self.driver.save_screenshot("./PruebasAutomatizadasPY/PostFailedTest/screenshot/step2_Makepost.png")
...
def GenerateItsOwnReport():
    path = "./PruebasAutomatizadasPY/PostFailedTest/Report/Report.html"
...
def run_test():
    try:
      screenshot_dir = './PruebasAutomatizadasPY/PostFailedTest/screenshot'
      ...
      report_dir = './PruebasAutomatizadasPY/PostFailedTest/report'
