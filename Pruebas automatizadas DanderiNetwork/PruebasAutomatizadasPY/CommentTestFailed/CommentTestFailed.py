...
class AddCommentTest:
    ...
    def step_start_sesion(self):
        ...
        try:
            ...
            self.driver.save_screenshot("./PruebasAutomatizadasPY/CommentTestFailed/screenshot/step1_login_page.png")
            ...
            self.driver.save_screenshot("./PruebasAutomatizadasPY/CommentTestFailed/screenshot/step1_login_submit.png")
    ...
    def addComment(self):
        ...
        try:
            ...
            postOptions.click()
            self.driver.save_screenshot("./PruebasAutomatizadasPY/CommentTestFailed/screenshot/step1_openoptions_submit.png")
            
            postOptions = self.driver.find_element(By.ID, "ContentFalse")
            postOptions.send_keys("Esto es un comentario de prueba")
            postOptions.submit()
            
            self.driver.save_screenshot("./PruebasAutomatizadasPY/CommentTestFailed/screenshot/step2_AddComment_submit.png")
            passed += 1
...
def GenerateItsOwnReport():
    path = "./PruebasAutomatizadasPY/CommentTestFailed/report/Report.html"
...
def run_test():
    try:
        screenshot_dir = './PruebasAutomatizadasPY/CommentTestFailed/screenshot'
        ...
        report_dir = './PruebasAutomatizadasPY/CommentTestFailed/report'
